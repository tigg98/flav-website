...
export function AdCard({ ad, campaignId }: AdCardProps) {
    return (
        <Link
            ...
            className="block bg-background rounded-xl border border-neutral-200 dark:border-neutral-800 hover:border-orange-500/50 dark:hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/5 transition-all overflow-hidden group"
        >
            {/* Media Preview */}
            ...
            <div className="p-4">
                <div className="flex items-start justify-between gap-2 mb-2">
                    <h4 className="font-semibold text-foreground group-hover:text-amber-500 transition-colors line-clamp-1">
                        {ad.title}
                    </h4>
